...
const Header = () => {
  return (
    <header className="hidden lg:flex  justify-between items-center p-4 sticky top-0 bg-[#E2E2E2] z-10">
      <h2 className="lg:w-[70%] text-xl lg:text-3xl font-bold">Dua Page</h2>
      <section className="flex items-center gap-4 justify-between lg:w-[30%]">
